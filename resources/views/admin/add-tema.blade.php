                  ...
                  <div class="col-md-6 col-12">
                        <div class="card">
                           ...
                           <div class="card-content">
                              <div class="card-body">
                                    <form class="form form-horizontal" action="/submit-tema" method="post" enctype="multipart/form-data">
                                       @csrf
                                       <div class="form-body">
                                          <div class="row">
                                                <div class="col-md-4">
                                                ...
                                                <div class="col-md-8 form-group">
                                                   <input type="text" id="first-name" class="form-control" name="tema">
                                                </div>
                              ...
                              <table class="table table-striped dataTable-table" id="table1">
                                 ...
                                 <tbody>                                                                 
                                    <tr>
                                       ...
                                       <td>{{$t->tema}}</td>
                                       <td>
                                       <a href="/delete/tema/{{$t->id}}" class="btn btn-danger m-1" onclick="return confirm('Yakin Untak Nonaktifkan Toko?')" data-toggle="tooltip" data-placement="top" title="Non">
